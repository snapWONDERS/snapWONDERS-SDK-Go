...
type AnalyseItem struct {
	...
	// camera_fingerprint, findings, steganography, forensic (ELA / noise-inconsistency tile
	// counts), and — video only — audio_splice and video_tamper (inter-frame tamper, frame
	// duplication, P-frame FFT, GPS timezone triangle). A plain map — the keys grow over time;
	// read what you need.
